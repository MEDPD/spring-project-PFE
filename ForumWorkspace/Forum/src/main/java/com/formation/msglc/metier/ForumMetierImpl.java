...
public class ForumMetierImpl implements IForumMetier{
	...
	public List<Reponse> getReponseBySujet(Long idSujet) {
		List<Reponse> reponses = dao.getReponseBySujet(idSujet);
		reponses.sort(Comparator.comparing(Reponse::getScore).reversed());
		return reponses;
	}
	...
	public boolean updateScore(Long auteurId, Long responseId) {
		...
		return dao.updateScore(auteurId, responseId);
	}
