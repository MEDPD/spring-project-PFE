...
public class Auteur {
	...
	private List<Reponse> responsesIScored;
	...
	// my function
	public List<Reponse> getResponsesIScored() {
		return responsesIScored;
	}
	// my function
	public void setResponsesIScored(List<Reponse> responsesIScored) {
		this.responsesIScored = responsesIScored;
	}
